                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="slider-content-10 text-center slider-animated-1">
                                  ...
                                  <img class="animated" src="images/fashion-4-slider-1.png" alt="slider">
                              </div>
                          </div>
                      </div>
                  </div>
                              ...
                              <div class="product-wrap" style="box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.16); border-radius: 11px;">
                                  <div class="product-img product-img-zoom mb-25">
                                      <a href="{{ route('detail', $product->slug) }}">
                                        ...
                                        @else
                                        <img src="/images/product/no-img.jpg" alt="">
                                        @endif 
                                      </a>
                                  </div>
              ...
              <div class="row grid">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 grid-item">
                      <div class="single-instafeed mb-3" data-aos="fade-up" data-aos-delay="200">
                          <a href="https://www.instagram.com/p/BuS0K_-hM3v/" target="_blank"><img src="/images/gallery/gallery-2.jpg" alt=""></a>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6 grid-item">
                      <div class="single-instafeed mb-4" data-aos="fade-up" data-aos-delay="200">
                          <a href="https://www.instagram.com/p/BtzvAhChQDC/" target="_blank"><img src="/images/gallery/gallery-3.jpg" alt=""></a>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6 grid-item">
                      <div class="single-instafeed mb-3" data-aos="fade-up" data-aos-delay="200">
                          <a href="https://www.instagram.com/p/BtumCdOBvE5/" target="_blank"><img src="/images/gallery/gallery.jpg" alt=""></a>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6 grid-item" style="margin-top: 10px;">
                      <div class="single-instafeed mb-3" data-aos="fade-up" data-aos-delay="200">
                          <a href="https://www.instagram.com/p/BtPt8sRhohb/" target="_blank" s><img src="/images/gallery/gallery-4.jpg" alt=""></a>
                      </div>
                  </div>
              </div>
          </div>
...
@push('addon-script')
    ...
    <script src="/vendor/images-loaded.js "></script>
    <script src="/vendor/instafeed.js "></script>
    <script src="/vendor/isotope.js "></script>
    <script src="/vendor/scrollup.js"></script>
    <script>
      (function($) {
          /*--------------------------------
          Slider active 1
